...
vector<pair<double, double> > LegendreRule::GetRule(unsigned int numberOfPoints, double a, double b)
{
...
void LegendreRule::legendre_compute_glr0 ( int n, double *p, double *pp )
...
void LegendreRule::legendre_compute_glr1 ( int n, double *x, double *w )
...
void LegendreRule::legendre_compute_glr2 ( double pn0, int n, double *x1, double *d1 )
...
void LegendreRule::rescale ( double a, double b, int n, double x[], double w[] )
...
double LegendreRule::rk2_leg ( double t1, double t2, double x, int n )
...
double LegendreRule::ts_mult ( double *u, double h, int n )
